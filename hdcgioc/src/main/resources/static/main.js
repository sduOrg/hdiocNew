...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>heroes works!</p>\n<div style=\"width: 100%;height: 1000px;background-color: burlywood;\">\n    <div  appDrag style=\"background-color: aquamarine;width: 100px;height: 100px;\" >\n    </div>\n    <button nz-button nzType=\"primary\">这是一个button</button>\n</div>\n");
...
let HeroesComponent = class HeroesComponent {
    ...
    ngOnInit() {
        let b = "hahha";
        let obj1 = { a: 1, b: 2 };
        let obj2 = Object.assign({}, obj1, { b });
        console.log(obj1); // {a: 1, b: 2}
        console.log(obj2);
        const locations = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"]((observer) => {
            let watchId;
...
module.exports = __webpack_require__(/*! /Users/apple/Desktop/work3/hdcgioc/src/main/my-app/src/main.ts */"./src/main.ts");
